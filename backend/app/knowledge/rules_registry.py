...
GLOBAL_RULES: list[RuleDef] = [
    ...
    RuleDef(
        ...
        title=_L(
            "برنامه زمان‌بندی یا مدت پیمان ناکافی",
            "Insufficient schedule or contract duration definition",
            "Unzureichende Terminplanung oder Vertragslaufzeit",
            "Planning ou durée du marché insuffisamment défini",
        ),
        description=_L(
            "بدون مایلستون و مسیر بحرانی، تأخیرات و جریمه‌ها قابل دفاع نیستند.",
            "Without milestones and critical path, delay liability becomes contested.",
            "Ohne Meilensteine und kritischen Pfad sind Verzugsfolgen streitig.",
            "Sans jalons et chemin critique, les retards deviennent contestables.",
        ),
        recommendation=_L(
...
COUNTRY_OVERRIDES: list[RuleDef] = [
    ...
    RuleDef(
        ...
        title=_L(
            "برنامه زمان‌بندی ناکافی (ایران)",
            "Insufficient schedule (Iran)",
            "Unzureichender Terminplan (Iran)",
            "Planning insuffisant (Iran)",
        ),
        description=_L(
            "بدون مدت پیمان و مایلستون شفاف، تمدید مدت و جریمه اختلاف‌زا می‌شود.",
            "Without clear duration/milestones, EOT and delay damages become contested.",
            "Ohne klare Laufzeit/Meilensteine werden Verzug und Verlängerung streitig.",
            "Sans durée/jalons clairs, prolongations et pénalités deviennent litigieuses.",
        ),
        recommendation=_L(
